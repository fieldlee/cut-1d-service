...
#[test]
fn optimize_different_stock_piece_weights() {
    let solution = Optimizer::new()
        .add_stock_piece(StockPiece {
            length: 96,
            weight: 1,
    ...
    // be a lower weight than (1) 120, it should use (2) 96 pieces instead.
    assert_eq!(solution.stock_pieces.len(), 2);
    for stock_piece in solution.stock_pieces {
...
#[test]
fn optimize_same_stock_piece_weights() {
    let solution = Optimizer::new()
        .add_stock_piece(StockPiece {
            length: 96,
            weight: 0,
...
fn deterministic_solutions() {
    ...
    solutions.windows(2).for_each(|window| {
        ...
        assert_eq!(solution1.weight, solution2.weight);
        solution1
            .stock_pieces
            .iter()
            ...
            .for_each(|(stock_piece1, stock_piece2)| {
                ...
                assert_eq!(stock_piece1.weight, stock_piece2.weight);
                stock_piece1
                    .cut_pieces
                    .iter()
